...
.to('.text1',{x:'-100%', delay:2.5, opacity : 0, ease:'power1.out' })

.from('.text2',{x:'-100%', opacity : 0, ease:'power1.out', },'<1')
.to('.text2',{x:'-100%', delay:2.5, opacity : 0, ease:'power1.out' })

.from('.text3',{x:'-100%', opacity : 0, ease:'power1.out',  },'<1')
.to('.text3',{x:'-100%', delay:2.5, opacity : 0, ease:'power3.out' })

.from('.text4',{x:'-100%', opacity : 0, ease:'power1.out',  },'<-.5')
.to('.text4',{x:'-100%', delay:2.5, opacity : 0, ease:'power1.out' })
